...
/*   Updated: 2021/12/17 11:14:19 by djeon            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    try {
        ...
        test2.decreaseGrade(36); // 4
        test2.signForm(test9);
        test9.execute(test2);

        test2.executeForm(test9);

        Intern test10 = Intern();
        Form* test11 = test10.makeForm("presidential pardon", "home");
        test2.signForm(*test11);
        test11->execute(test2);
        Form* test12 = test10.makeForm("hihi", "home");
        test12->execute(test2);
